...
print('Subtraction_1 schwarz Pixeln =',800*600-count1)
print('Subtraction_1_add180 schwarz Pixeln =',800*600-count1add180)
print('Subtraction_2 schwarz Pixeln =',800*600-count2)
print('Subtraction_2_add180 schwarz Pixeln =',800*600-count2add180)
